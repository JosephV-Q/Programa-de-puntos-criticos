import type { SimulationForm, SimulationResult, SimulationSummary, StructuralModelRecord } from '../models/simulation'

const API_URL = import.meta.env.VITE_API_URL ?? 'http://localhost:8000/api'

export async function runSimulation(form: SimulationForm, token: string): Promise<SimulationResult> {
