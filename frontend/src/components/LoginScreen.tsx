  ...
  return (
    <main className="auth-shell">
      <section className="auth-art">
        ...
        <p>
          Accede a tus modelos, simulaciones y recomendaciones de
          instrumentación desde un mismo espacio de trabajo.
        </p>
        ...
        <div className="auth-heading">
          ...
          <p>
            {mode === "login"
              ...
              : "Tu cuenta se registrará como Ingeniero Estructural."}
          </p>
        </div>
